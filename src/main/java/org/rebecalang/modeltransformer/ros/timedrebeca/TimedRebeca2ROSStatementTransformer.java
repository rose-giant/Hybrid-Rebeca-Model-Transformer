...
@Component
public class TimedRebeca2ROSStatementTransformer {
...
//		expressionTransformer.prepare();
	...
	protected String resolveStatement(Statement statement) {
		...
		exceptionContainer.addException(new StatementTransformingException("Unknown translation rule for type " + 
